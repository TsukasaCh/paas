...
export const PLANS: Record<Plan, PlanLimits> = {
  FREE: { label: "Free", maxReplicas: 1, memoryMb: 256, cpus: 0.5 },
  PRO: { label: "Pro", maxReplicas: 2, memoryMb: 4096, cpus: 2 },
  ENTERPRISE: { label: "Enterprise", maxReplicas: 50, memoryMb: 0, cpus: 0 },
};
